    ...
    public class FriendsUI : MonoBehaviour {
        ...
        public void DrawUsers(Dictionary<string, (string, RelationshipStatus)> usernames) {
            ...
            foreach (var kv in usernames) {
                UserItemSlot userItemSlot = Instantiate(usersSection.itemSlotPrefab, usersSection.contentSection.transform).GetComponent<UserItemSlot>();
                userItemSlot.Draw(kv);
            }
        ...
        public void DrawItemSlot(GameObject prefab, FriendData item, RectTransform contentSection) {
            FriendsItemSlot friendItemSlot = Instantiate(prefab, contentSection.transform).GetComponent<FriendsItemSlot>();
            friendItemSlot.Draw(item);
        }
